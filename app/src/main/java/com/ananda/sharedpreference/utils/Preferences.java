package com.ananda.sharedpreference.utils;
...
Deskripsi Pengerjaan    : Membuat Preferences
...
public class Preferences {
    ...
    private static final String PREF_SESSION = "com.ananda.sharedpreferences.session";
